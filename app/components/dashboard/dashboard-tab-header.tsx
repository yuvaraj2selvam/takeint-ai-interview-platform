                ...
                <div className="flex justify-between items-center flex-col md:flex-row gap-2">
                    ...
                    <div className="flex w-full z-10 gap-2 flex-row justify-between md:flex-col items-center md:items-start">
                        ...
                        <div className="relative z-10 w-[160px] self-end md:w-[200px] bg-dark text-white text-sm rounded-full overflow-hidden">
                            <div
                                className="absolute top-0 left-0 h-full bg-[repeating-linear-gradient(45deg,_transparent,_transparent_4px,_#1cc255,_#1cc255_6px)]"
                                style={{ width: `60%` }}
                            />
                    ...
                    <div className="flex z-10 gap-2 w-full flex-row md:flex-col justify-between items-center md:items-start">
                        ...
                        <div className="relative z-10 self-end w-[160px] md:w-[200px] bg-[#1cc255] text-black text-sm rounded-full overflow-hidden">
                            <div
                                className="absolute top-0 left-0 h-full bg-[repeating-linear-gradient(45deg,_transparent,_transparent_4px,_#000_2px,_#000_6px)]"
                                style={{ width: `85%` }}
                            />
